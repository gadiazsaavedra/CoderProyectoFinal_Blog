...
from AppBlog.forms import BlogFormulario, BloggerFormulari, UserRegisterForm, UserEditForm
#para el login
...
class BloggerList(ListView):
    ...
    model = Blogger
    template_name = "AppBlog/blogges_list.html"
    
#Detalle - SUPER Leer - Buscar!!!!!
class BloggerDetalle(DetailView):
    
    model = Blogger
    template_name = "AppBlog/blogger_detalle.html"
