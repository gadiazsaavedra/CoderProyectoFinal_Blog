...
class Blog(models.Model):
    ...
    def __str__(self):
        return f"BLOG: {self.title} NUMERO: {self.numero} DESCRIPTION: {self.description} BLOGGERblogger: {self.blogger} created_at: {self.created_at} updated_at: {self.updated_at}"
