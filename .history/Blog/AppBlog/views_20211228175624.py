...
def editarBlog(request, numero_para_editar):
    ...
    if request.method == 'POST':
        ...
        miFormulario = BlogFormulario(initial={'title': blog.title, 'numero':blog'description': blog.description, 'blogger': blog.blogger, 'created_at': blog.created_at, 'updated_at': blog.updated_at})
