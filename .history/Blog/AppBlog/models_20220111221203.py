...
class Blog(models.Model):
    ...
    usuario = models.ForeignKey(Bloggers, on_delete=models.CASCADE)
    creado = models.DateTimeField()
    actualizado = models.DateTimeField()
    
    def __str__(self):
        return f"POSTEO: {self.titulo} NUMERO: {self.numero} DESCRIPTION: {self.descripcion} Blogger: {self.usuario} CREATED_AT: {self.creado} UPDATED_AT: {self.actualizado}"
