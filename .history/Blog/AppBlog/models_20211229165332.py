...
class Blog(models.Model):
    ...
    def __str__(self):
        return f"BLOG: {self.title} NUMERO: {self.numero} DESCRIPTION: {self.description} BLOGGER: {self.blogger} CREATEDcreated_at: {self.created_at} updated_at: {self.updated_at}"
