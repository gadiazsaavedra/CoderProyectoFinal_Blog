...
class Blog(models.Model):
    ...
    def __str__(self):
        return f"BLOG: {self.title} NUMERO: {self.numero} DESCRIPTION: {self.description} BLOGGER: {self.blogger} CREATED_AT: {self.created_at} UPDATEDupdated_at: {self.updated_at}"
